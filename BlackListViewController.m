...
- (void) copyDatabaseIfNeeded {
    ...
    if(!success) {
        ...
        NSString *defaultDBPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"blacklistnumber.db"];
...
- (NSString *) getDBPath {
    ...
    return [documentsDir stringByAppendingPathComponent:@"blacklistnumer.db"];
}
